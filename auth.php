							...
							<div class="display-tc">
								<div class="row">
									<div class="col-md-8 animate-box">
										...
										<p>Для предотвращения несанкционированного доступа к данным информационной системы была введена обязательная авторизация.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-1">
						<div class="gtco-contact-info">
							...
							<ul >
								<li class="address">П.Бровки 6, Минск, Беларусь</li>
								<li class="phone"><a href="#">+375(29) 236 55 98</a></li>
